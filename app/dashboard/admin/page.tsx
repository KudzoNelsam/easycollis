...
export default function AdminDashboard() {
  ...
  const [transactions] = useState([
    { id: "tx-1", user: "Marie Dupont", type: "Achat PASS", amount: 5000, date: "2025-01-08", status: "completed" },
    {
      id: "tx-2",
      user: "Transport Koné",
      type: "Achat PASS GP",
    ...
    { id: "tx-3", user: "Jean Martin", type: "Achat PASS", amount: 2500, date: "2025-01-06", status: "pending" },
    {
      id: "tx-4",
      user: "Express Dakar",
      type: "Achat PASS GP",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Administration EASYCOLLIS</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-2xl font-bold mt-2">{(stats.totalRevenue / 1000).toFixed(0)}K</p>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">Derniers GPs inscrits</CardTitle>
                  </CardHeader>
                      ...
                      <div key={gp.id} className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                            <span className="font-semibold text-primary">{gp.name[0]}</span>
                          </div>
                          <div>
                        ...
                        {gp.verified ? (
                          <Badge className="bg-green-500/10 text-green-600">Vérifié</Badge>
                        ) : (
                    ...
                    {transactions.slice(0, 4).map((tx) => (
                      <div key={tx.id} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-semibold text-sm">{tx.amount.toLocaleString()} FCFA</p>
                          <Badge
                            className={
                              tx.status === "completed"
            ...
            <TabsContent value="gps" className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Gérez les comptes GP et leurs vérifications</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        <div className="flex items-start gap-4">
                          <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                            <span className="font-bold text-primary">{gp.name[0]}</span>
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
                            ...
                            <p className="text-sm text-muted-foreground">{gp.email}</p>
                      ...
                      >
                        <div className="flex items-start gap-4">
                          <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center shrink-0">
                            <span className="font-bold text-foreground">{client.name[0]}</span>
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
            ...
            <TabsContent value="transactions" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Toutes les transactions de la plateforme</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <tbody>
                        {transactions.map((tx) => (
                          <tr key={tx.id} className="border-b">
                            ...
                            <td className="p-3 text-sm font-semibold">{tx.amount.toLocaleString()} FCFA</td>
