    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/legal#responsabilite" className="text-sm text-muted-foreground hover:text-foreground">
                  Responsabilité
                </Link>
              </li>
              <li>
                <Link href="/legal#cgv" className="text-sm text-muted-foreground hover:text-foreground">
                  CGV
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-muted-foreground">contact@easycollis.com</li>
        ...
        <div className="mt-8 border-t border-border pt-8 text-center">
          <p className="text-sm text-muted-foreground">© 2025 EASYCOLLIS. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )
